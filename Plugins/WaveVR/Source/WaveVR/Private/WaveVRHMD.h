...
public:
	...
	virtual bool DeviceIsAPrimaryView(EStereoscopicPass Pass) override { LOG_FUNC(); return IStereoRendering::DeviceIsAPrimaryView(Pass); }
	virtual bool DeviceIsASecondaryView(EStereoscopicPass Pass) override { LOG_FUNC(); return IStereoRendering::DeviceIsASecondaryView(Pass); }
	virtual bool DeviceIsAnAdditionalView(EStereoscopicPass Pass) override { LOG_FUNC(); return IStereoRendering::DeviceIsAnAdditionalView(Pass); }
